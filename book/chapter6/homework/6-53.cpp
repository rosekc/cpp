...
int main()
{
    ...
    cout<<"The minimum number is: "<<minimum(x1,y1)<<endl<<endl;
    ...
    cout<<"The minimum strings is: "<<minimum(x2,y2)<<endl<<endl;
    ...
    cout<<"The minimum double number is: "<<minimum(x3,y3)<<endl;
    return 0;
}
